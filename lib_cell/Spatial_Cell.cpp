...
Spatial_Cell::Spatial_Cell (double _dt, int seed, int cell_ID, double bcl, std::string tubular_map_file, double ltcc_change, std::string serca_map) : sc(CSubcell(55, 17,  11,  1,  1, cell_ID))
	, cc (CCell()), m_cell_ID(cell_ID)
{
	...
	sc.init(0.2, 500, nai_res, ltcc_change, serca_map);
